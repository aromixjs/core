// TODO: re-implement without remeda dependency
...
//
// 	notNull() {
// 		if (this[$def].kind === "computed") throw new Error("computed fields cannot be notNull");
// 		return this.make({ ...this[$def], notNull: true });
// 	}
//
// 	default(value: FieldDefault): FieldModifier {
// 		if (this[$def].kind === "computed") throw new Error("computed fields cannot have a default");
// 		return this.make({ ...this[$def], default: value });
// 	}
//
// 	client(ops?: ClientOp[]): FieldModifier {
// 		if (this[$def].kind === "computed") {
// 			if (ops && ops.length > 0) throw new Error("computed fields are read-only — call .client() with no args");
// 			return this.make({ ...this[$def], client: { read: true, insert: false, update: false } });
// 		}
//
// 		return this.make({
// 			...this[$def],
