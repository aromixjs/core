 ...
 */
function addInstanceProperties(serviceInstance: any, targetObj: Record<PropertyKey, unknown>) {
 ...
 */
function addPrototypeProperties(serviceInstance: any, targetObj: Record<PropertyKey, unknown>) {
